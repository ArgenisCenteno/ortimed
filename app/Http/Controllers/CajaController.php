        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($caja)
                ...
                ->addColumn('created_at', function ($categoria) {
                    return Carbon::parse($categoria->created_at)->format('Y-m-d H:i:s');
                })
                ->addColumn('updated_at', function ($categoria) {
                    return Carbon::parse($categoria->updated_at)->format('Y-m-d H:i:s');
                })
